...
public class TieSdkHelper {
    ...
    /**
     * 判断 {@link TieEngine#init} 的结果是否达到本 Demo 的“可启用增强”标准：
     * <ul>
     *   <li>错误码为 {@link InitResult#CODE_OK}；</li>
     *   <li>预热末次推理耗时小于 20ms。</li>
     * </ul>
     * <p>20ms 是 Demo 为保证播放流畅设置的启用阈值，不是 TsrSdk 的 API 契约；客户可按自身帧率目标调整。</p>
     *
     * @param result TieEngine.init 返回值；为 null 时返回 false。
     */
    public static boolean isTieEngineInitReady(InitResult result) {
        return result != null

...
### **2.3 体验Demo**
#### **2.3.1 安装包**
Android设备扫码后，用浏览器打开下载apk并安装Demo App，立即体验超分SDK效果。
![android-demo-qrcode.png](./docs/android-demo-qrcode.png)
#### **2.3.2 源码**
...
### **2.3 体验Demo**
#### **2.3.1 安装包**
iPhone扫码后，用Safari浏览器打开，点击按钮下载ipa并安装Demo App，立即体验超分SDK效果。
![ios-demo-qrcode.png](./docs/ios-demo-qrcode.png)

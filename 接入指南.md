...
```
#### **2.1.2 TSRPass**
[TSRPass](https://tencentyun.github.io/TSR/android-docs/com/tencent/mps/tie/api/TSRPass.html)是用于进行超分辨率渲染的类，它包括了init、render和release方法。在使用TSRPass前，您需要调用init方法进行初始化。在使用结束后，您需要调用release方法释放资源。
...
[TSRSDK ANDROID API文档](https://tencentyun.github.io/TSR/android-docs/index.html)
### **2.3 体验Demo**
#### **2.3.1 安装包**
